...
$dt = date("md");
$td = "1_stud$dt";
  $sql = "SELECT * from $td where mul <>'1멀' and mul <>'2멀' and second <> '정독실' and second <> '동아리실1' and second <> '동아리실2' and second <> '원탁1' and second <> '원탁2' and second <> '외출' and second <> '귀가' and second <> '사물함' and second <> 'X'";
  ...
  //${'c'.$i} = $chk;
  //${'p'.$i} = $i;
  $s1 = "SELECT * from $td where mul <>'1멀' and mul <>'2멀' and second <> '정독실' and second <> '동아리실1' and second <> '동아리실2' and second <> '원탁1' and second <> '원탁2' and second <> '외출' and second <> '귀가' and second <> '사물함' and second <> 'X'";
  $s2 = "SELECT * from $td where mul <>'1멀' and mul <>'2멀' and second <> '정독실' and second <> '동아리실1' and second <> '동아리실2' and second <> '원탁1' and second <> '원탁2' and second <> '외출' and second <> '귀가' and second <> '사물함' and second <> 'X' and two='1'";
  $s3 = "SELECT * from $td where mul <>'1멀' and mul <>'2멀' and second <> '정독실' and second <> '동아리실1' and second <> '동아리실2' and second <> '원탁1' and second <> '원탁2' and second <> '외출' and second <> '귀가' and second <> '사물함' and second <> 'X' and two='0'";
