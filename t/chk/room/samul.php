...
$dt = date("md");
$td = "1_stud$dt";
  $sql = "SELECT * from $td WHERE first='사물함'";
  ...
  //${'c'.$i} = $chk;
  //${'p'.$i} = $i;
  $s1 = "SELECT * from $td WHERE first='사물함'";
  $s2 = "SELECT * from $td WHERE first='사물함' and one='1'";
  $s3 = "SELECT * from $td WHERE first='사물함' and one='0'";
