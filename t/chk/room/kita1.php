...
$dt = date("md");
$td = "1_stud$dt";
  $sql = "SELECT * from $td WHERE mul <>'1멀' and mul <>'2멀' and first <> '정독실' and first <> '동아리실1' and first <> '동아리실2' and first <> '원탁1' and first <> '원탁2' and first <> '외출' and first <> '귀가' and first <> '사물함' and first <> 'X'";
  ...
  //${'c'.$i} = $chk;
  //${'p'.$i} = $i;
  $s1 = "SELECT * from $td WHERE mul <>'1멀' and mul <>'2멀' and first <> '정독실' and first <> '동아리실1' and first <> '동아리실2' and first <> '원탁1' and first <> '원탁2' and first <> '외출' and first <> '귀가' and first <> '사물함' and first <> 'X'";
  $s2 = "SELECT * from $td WHERE mul <>'1멀' and mul <>'2멀' and first <> '정독실' and first <> '동아리실1' and first <> '동아리실2' and first <> '원탁1' and first <> '원탁2' and first <> '외출' and first <> '귀가' and first <> '사물함' and first <> 'X' and one='1'";
  $s3 = "SELECT * from $td WHERE mul <>'1멀' and mul <>'2멀' and first <> '정독실' and first <> '동아리실1' and first <> '동아리실2' and first <> '원탁1' and first <> '원탁2' and first <> '외출' and first <> '귀가' and first <> '사물함' and first <> 'X' and one='0'";
  $qr1 = mysqli_query($conn, $s1);
  $qr2 = mysqli_query($conn, $s2);
  $qr3 = mysqli_query($conn, $s3);
  $rows1 = mysqli_num_rows($qr1);
  $rows2 = mysqli_num_rows($qr2);
  $rows3 = mysqli_num_rows($qr3);
 ?>
 <script>
